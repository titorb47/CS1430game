...
//THESE ARE THE DECLARED VARIABLES THAT ARE USED FOR THE ENTIRE GAME
//DEFINED IN GameConstants.cpp

//extern makes these variables global


/* These first three are not actually constants, I just found
   that putting them here was helpful to keep track of them */
...
extern const int SCORE_BACKGROUND_X;
extern const int SCORE_BACKGROUND_Y;
extern const int SCORE_BACKGROUND_W;
extern const int SCORE_BACKGROUND_H;
...
extern int ENEMY_SPAWNRATE_MODIFIER;
...
extern const int ENEMY_COLLIDER_WIDTH;
extern const int ENEMY_COLLIDER_HEIGHT;
